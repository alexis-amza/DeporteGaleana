...
public class InicioFragment extends Fragment {
    ...
    private CardView cardTablaGeneral, cardPartidos, cardNoticias, cardGoleadores, cardAjustes, cardAcercaDe;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        cardNoticias = vista.findViewById(R.id.cardNoticias);
    ...
    private void eventosMenu() {
        ...
        cardNoticias.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                interfaceComunicaFragments.abrirNoticias();
            }
        });
