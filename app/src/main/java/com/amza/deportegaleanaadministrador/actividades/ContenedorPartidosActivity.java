...
import com.amza.deportegaleanaadministrador.Fragments.AgregarPartidosFragment;
import com.amza.deportegaleanaadministrador.Fragments.PartidosFinalizadosFragment;
...
public class ContenedorPartidosActivity extends AppCompatActivity implements AgregarPartidosFragment.OnFragmentInteractionListener,
    ...
    public AlertDialog dialogoAyudaPartidos(){
        ...
        builder.setTitle("Ayuda").setMessage("En este apartado de la aplicacion podrás agregar los siguientes" +
                " partidos de la jornada en el apartado próximos paridos.\n\n" +
                "También podrás agregar los resultados de la jornada una vez que los partidos terminen" +
                " en el apartado de partidos finalizados").setPositiveButton("Aceptar",
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public static Fragment newInstance(int sectionNumber) {
            ...
            switch (sectionNumber){
                case 1:
                    fragment = new AgregarPartidosFragment();
                    break;
                case 2:
